<table class="content_list">
    ...
    <tr>
        <td><textarea name="notebook" cols="100" rows="6" id="notebook" onblur="updateNotebook()"> <?php echo "notebook"?></textarea></td>
    </tr>
</table>
<table class="content_list">
    <thead>
...
<script language="javascript">
    ...
    function updateNotebook()
    {
        ...
        $.post("<?=\yii\helpers\Url::to(['notebookUpdate'])?>",{notebook:$('#notebook').val()},function(response){
            alert(response);
