...
$this->title = Yii::t('app','Blog'). ' - ' . Yii::t('app','Xinyeweb');
...
<div class="blog-container">
    ...
    <div class="blog-post">
        <?php foreach($blogList as $v): ?>
            <article>
                <figure><a href="<?= \yii\helpers\Url::toRoute(['blog/view','id'=>$v['id']]) ?>"><img src="<?= Yii::$app->request->baseUrl ?>/web/xinye2014/images/blog-no-img.png" alt=""></a></figure>
                <div class="main">
                    <h5><a href="<?= \yii\helpers\Url::toRoute(['blog/view','id'=>$v['id']]) ?>"><?= $v['title'] ?></a> <small>[ <?=$v['category']['name']?> ]</small></h5>
